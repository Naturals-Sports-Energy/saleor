...
CELERY_RESULT_BACKEND = os.environ.get("CELERY_RESULT_BACKEND", os.environ.get("CELERY_BROKER_URL", os.environ.get("CLOUDAMQP_URL")) or None)
...
PLUGINS = [
    ...
    "saleor.payment.gateways.eway.plugin.EwayGatewayPlugin",
